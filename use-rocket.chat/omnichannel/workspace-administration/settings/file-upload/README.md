...
You can find a more detailed guide on how to set up your Amazon S3 server [here](../../../../workspace-administration/settings/file-upload/broken-reference/).
...
The settings used when configuring a Google Cloud Storage server. You can find more details [here](../../../../workspace-administration/settings/file-upload/broken-reference/).
