...
When [deploying ](../../workspace-administration/broken-reference/)a self-managed Rocket.Chat `>=6.x` workspace you are automatically required to register your workspace upon completing the [rocket.chat-setup-wizard.md](../../../setup-and-configure/accessing-your-workspace/rocket.chat-setup-wizard.md "mention").
