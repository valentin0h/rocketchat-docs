...
{% hint style="warning" %}
Queues follow the [routing algorithm](../omnichannel/workspace-administration/settings/omnichannel-admins-guide/queue-types-routing-algorithm.md) specified by the workspace administrator.
{% endhint %}
